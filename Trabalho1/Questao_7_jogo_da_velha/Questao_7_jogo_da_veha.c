...
int main()
{
    ...
    do
    {
		...
		if(strcmp(escolha, "A1") == 0 || strcmp(escolha, "a1") == 0)
			numero = 1;
		else if(strcmp(escolha, "A2") == 0 || strcmp(escolha, "a2") == 0)
			numero = 2;
		else if(strcmp(escolha, "A3") == 0 || strcmp(escolha, "a3") == 0)
			numero = 3;
		else if(strcmp(escolha, "B1") == 0 || strcmp(escolha, "b1") == 0)
			numero = 4;
		else if(strcmp(escolha, "B2") == 0 || strcmp(escolha, "b2") == 0)
			numero = 5;
		else if(strcmp(escolha, "B3") == 0 || strcmp(escolha, "b3") == 0)
			numero = 6;
		else if(strcmp(escolha, "C1") == 0 || strcmp(escolha, "c1") == 0)
			numero = 7;
		else if(strcmp(escolha, "C2") == 0 || strcmp(escolha, "c2") == 0)
			numero = 8;
		else if(strcmp(escolha, "C3") == 0 || strcmp(escolha, "c3") == 0)
			numero = 9;
		else
        ...
        if (numero == 1 && quadrado[1] == '1')
            quadrado[1] = sinal;

        else if (numero == 2 && quadrado[2] == '2')
            quadrado[2] = sinal;

        else if (numero == 3 && quadrado[3] == '3')
            quadrado[3] = sinal;

        else if (numero == 4 && quadrado[4] == '4')
            quadrado[4] = sinal;

        else if (numero == 5 && quadrado[5] == '5')
            quadrado[5] = sinal;

        else if (numero == 6 && quadrado[6] == '6')
            quadrado[6] = sinal;

        else if (numero == 7 && quadrado[7] == '7')
            quadrado[7] = sinal;

        else if (numero == 8 && quadrado[8] == '8')
            quadrado[8] = sinal;

        else if (numero == 9 && quadrado[9] == '9')
            quadrado[9] = sinal;
